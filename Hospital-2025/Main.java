...
import Vistas.LoginPanel; // Importar un panel personalizado llamado LoginPanel desde el paquete Vistas
...
public class Main {
    ...
    public static void Main(String[] args) {
        ...
        miVentana.setSize(500,800);    //establecer el tamaño de la ventana (altura x ancho)
        miVentana.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);   // Al cerrar la ventana, el programa termina completamente
        miVentana.setLayout(new BorderLayout());   // Usar un BorderLayout para organizar los componentes (NORTE, SUR, ESTE, OESTE, CENTRO)
        
        //panel banner 
        JPanel panelBanner = new JPanel();
        panelBanner.setPreferredSize(new Dimension(500,800)); // Establecer tamaño preferido del panel (será considerado por el layout)
        panelBanner.setSize(500, 300);// Establecer tamaño explícito (⚠️ puede ser ignorado por el layout manager)
        panelBanner.setOpaque(true);     // Hacer que el fondo del panel sea visible (no transparente)
